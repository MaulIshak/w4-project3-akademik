...
<div class="d-flex my-3 row">
  ...
  <div class="row col-auto">
    ...
    <div class="col-auto ms-auto">
          <a href="/admin/matakuliah/create" class="btn btn-success">+ Tambah Mata Kuliah</a>
      </div>
            ...
            <tr>
                ...
                <td>
                  <div class="d-flex justify-content-evenly">
                      <a href="/admin/matakuliah/detail/<?=$matkul['kode_mata_kuliah']?>" class="btn btn-primary btn-sm">
                      ...
                      <a href="/admin/matakuliah/edit/<?= $matkul['kode_mata_kuliah'] ?>" class="btn btn-warning btn-sm">
                        ...
                        <form action="/admin/matakuliah/delete/<?= $matkul['kode_mata_kuliah'] ?>" method="post" onsubmit="return confirm('Apakah Anda yakin ingin mengirim data ini?');" >
